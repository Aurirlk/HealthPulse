...
public class AgentCoordinator {
    ...
    /** Agent 角色定义 */
    private static final Map<String, AgentRole> AGENT_ROLES = new LinkedHashMap<>();

    static {
        AGENT_ROLES.put("doctor", new AgentRole(
                "doctor", "全科医生",
                Arrays.asList("症状", "疾病", "疼痛", "发烧", "咳嗽", "头痛", "感冒", "治疗", "诊断", "不适", "难受"),
                "症状分析、分诊建议、用药指导"
        ));
        AGENT_ROLES.put("nutritionist", new AgentRole(
                "nutritionist", "营养师",
                Arrays.asList("饮食", "营养", "减肥", "增重", "卡路里", "蛋白质", "维生素", "食谱", "膳食", "体重管理"),
                "饮食规划、营养搭配、体重管理"
        ));
        AGENT_ROLES.put("psychologist", new AgentRole(
                "psychologist", "心理咨询师",
                Arrays.asList("心理", "情绪", "焦虑", "抑郁", "压力", "失眠", "睡不着", "心情", "烦躁", "恐惧"),
                "情绪疏导、压力管理、心理支持"
        ));
        AGENT_ROLES.put("analyst", new AgentRole(
                "analyst", "报告分析师",
                Arrays.asList("报告", "体检", "指标", "化验", "血糖", "血压", "血脂", "肝功", "肾功", "异常"),
                "体检报告解读、异常指标分析"
        ));
        AGENT_ROLES.put("consultant", new AgentRole(
                "consultant", "健康助手",
                Arrays.asList("健康", "养生", "运动", "锻炼", "保健", "预防", "生活", "习惯"),
                "综合健康咨询、健康生活方式建议"
        ));
        AGENT_ROLES.put("general_assistant", new AgentRole(
